...
f = open(r"C:\Users\Purushotham\Desktop\oracle\day_04\case_study\students.csv", "r")
columns = f.readline()
...
def assignranks(robjs): # robjs is a list of student objects
    a = []
    sobjs = robjs
    for obj in sobjs:
...
def classreport2file(sobjs, file):
    ...
    path = r"C:\Users\Purushotham\Desktop\oracle\day_04\case_study"
...
'''
classreport(objs)
classreport2file(objs, 'report2.txt')
f.close()
